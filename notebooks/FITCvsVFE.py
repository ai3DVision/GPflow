...
def snelsonDemo():
    ...
    VFElog_likelihoods = np.ones( len(VFEiters) ) * VFEcb.log_likelihoods[-1]
    VFElog_likelihoods[0:len(VFEcb.log_likelihoods)] = VFEcb.log_likelihoods
    VFEhold_out_likelihood = np.ones( len(VFEiters) ) *  VFEcb.hold_out_likelihood[-1]
    VFEhold_out_likelihood[0:len(VFEcb.hold_out_likelihood)] = VFEcb.hold_out_likelihood
    ...
    save_tikz("true_model.tikz",figA, figurewidth='\\figurewidth', figureheight = '\\figureheight')
    save_tikz("approximations.tikz",figB, figurewidth='\\figurewidth', figureheight = '\\figureheight')
